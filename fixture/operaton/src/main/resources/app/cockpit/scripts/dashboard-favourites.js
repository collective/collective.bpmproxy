 ...
 */
function isFavourite(processDefinitionKey) {
    var favourites = loadFavourites();
    return favourites.some(function (f) { return f.key === processDefinitionKey; });
}
/**
 * Add a process definition to favourites (by key)
 */
function addFavourite(definition) {
    var favourites = loadFavourites();
    if (!favourites.some(function (f) { return f.key === definition.key; })) {
 ...
 */
function removeFavourite(processDefinitionKey) {
    var favourites = loadFavourites();
    var filtered = favourites.filter(function (f) { return f.key !== processDefinitionKey; });
...
var StarButton = function (_a) {
    ...
    var _b = reactExports.useState(false), isFav = _b[0], setIsFav = _b[1];
    var _c = reactExports.useState(null), definition = _c[0], setDefinition = _c[1];
    ...
    var handleToggle = function () {
        ...
        if (isFav) {
            removeFavourite((_a = definition.key) !== null && _a !== void 0 ? _a : '');
            setIsFav(false);
        }
        else {
            addFavourite({
                key: (_b = definition.key) !== null && _b !== void 0 ? _b : '',
                name: (_c = definition.name) !== null && _c !== void 0 ? _c : null,
            });
            setIsFav(true);
        }
    };
    ...
    return (React.createElement("button", { type: "button", className: "btn btn-default btn-sm btn-outline-secondary", onClick: handleToggle, "aria-label": isFav ? 'Remove from favourites' : 'Add to favourites', title: isFav ? 'Remove from favourites' : 'Add to favourites', style: {
            width: '40px',
            height: '34px',
            marginTop: '4px',
            padding: '4px 6px',
            minWidth: '40px',
        } }, isFav ? (React.createElement(FaStar, { "aria-hidden": "true", style: { fontSize: '16px' } })) : (React.createElement(FaRegStar, { "aria-hidden": "true", style: { fontSize: '16px' } }))));
};
/**
 * Dashboard table showing favourite process definitions
 */
var DashboardTable = function (_a) {
    var api = _a.api;
    var _b = reactExports.useState([]), favourites = _b[0], setFavourites = _b[1];
    var _c = reactExports.useState(new Map()), statistics = _c[0], setStatistics = _c[1];
    // eslint-disable-next-line @typescript-eslint/naming-convention -- Common React state naming pattern
    var _d = reactExports.useState(true), loading = _d[0], setLoading = _d[1];
    ...
    var tableData = reactExports.useMemo(function () {
        return favourites.map(function (fav) {
            ...
            var versionStats = (_a = statistics.get(fav.key)) !== null && _a !== void 0 ? _a : [];
            // Find latest version
            var latestVersion = 0;
            var latestVersionId = '';
            var tenantId = null;
            var anySuspended = false;
            for (var _i = 0, versionStats_1 = versionStats; _i < versionStats_1.length; _i++) {
                var stat = versionStats_1[_i];
                var version = (_c = (_b = stat.definition) === null || _b === void 0 ? void 0 : _b.version) !== null && _c !== void 0 ? _c : 0;
                if (version > latestVersion) {
                    latestVersion = version;
                    latestVersionId = (_d = stat.id) !== null && _d !== void 0 ? _d : '';
                    tenantId = (_f = (_e = stat.definition) === null || _e === void 0 ? void 0 : _e.tenantId) !== null && _f !== void 0 ? _f : null;
                }
                if ((_g = stat.definition) === null || _g === void 0 ? void 0 : _g.suspended) {
                    anySuspended = true;
                }
            }
            ...
            for (var _k = 0, versionStats_2 = versionStats; _k < versionStats_2.length; _k++) {
                var stat = versionStats_2[_k];
    ...
    var handleRemoveFavourite = function (definitionKey) {
    ...
    var columns = reactExports.useMemo(function () {
        return [
            ...
            },
            {
                ...
                Cell: function (_a) {
                    ...
                    return (React.createElement(Clippy, { value: value },
                        React.createElement("a", { href: "#/process-definition/".concat(row.original.latestVersionId, "/runtime") },
                            value,
                            " ",
                            React.createElement("span", { style: { color: '#999', fontSize: '0.9em' } },
                                "(v",
            ...
            },
            {
                ...
                Cell: function (_a) {
                    var value = _a.value;
                    return React.createElement("span", null, value !== null && value !== void 0 ? value : '');
                },
            },
            {
                Header: 'Actions',
                ...
                Cell: function (_a) {
                    var row = _a.row;
                    return (React.createElement("button", { type: "button", className: "btn btn-default btn-sm", onClick: function () {
                            handleRemoveFavourite(row.original.key);
                        }, "aria-label": "Remove from favourites", title: "Remove from favourites", style: {
                            padding: '4px 8px',
                            minWidth: '32px',
                        } },
                        React.createElement(FaStar, { "aria-hidden": "true" })));
                },
            },
            // eslint-disable-next-line @typescript-eslint/no-explicit-any -- Custom column properties for AngularJS compatibility
        ];
    }, [handleRemoveFavourite]);
    var title = "".concat(favourites.length, " favourite process definition").concat(favourites.length !== 1 ? 's' : '');
    // Hide panel completely when no favourites
    if (!loading && favourites.length === 0) {
        return null;
    }
    return (React.createElement(DashboardSection, { title: title, isLoading: loading, hasData: favourites.length > 0, emptyMessage: "No favourite process definitions yet. Use the star button on a process definition to add it to favourites." },
        React.createElement(SortableTable, { columns: columns, data: tableData, className: "process-definitions-list cam-table search-results", ariaLabel: "Favourite process definitions" })));
};
// =============================================================================
// Plugin Exports
// =============================================================================
var dashboardFavourites = [
    {
        ...
        render: function (node, _a) {
            ...
            clientExports.createRoot(node).render(React.createElement(React.StrictMode, null,
                React.createElement(StarButton, { api: api, processDefinitionId: processDefinitionId })));
        },
    },
    {
        ...
        render: function (node, _a) {
            var api = _a.api;
            clientExports.createRoot(node).render(React.createElement(React.StrictMode, null,
                React.createElement(DashboardTable, { api: api })));
        },
    },
];

export { dashboardFavourites as default };
