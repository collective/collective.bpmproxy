            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getBpmnElements(processDefinitionId, api)];
                    case 1:
                        _a = _b.sent(), activities_1 = _a.activities, sequenceFlows_1 = _a.sequenceFlows;
...
var BatchSignalForm = function (_a) {
    ...
    return (React.createElement(FormProvider, __assign({}, methods),
        React.createElement("form", { onSubmit: function (e) {
            ...
            React.createElement("div", { className: "modify-form__header" },
                React.createElement(WarningBox, { title: "Engine-Wide Broadcast" }, "Signals are delivered to ALL matching signal catch events across ALL process definitions and instances in the engine \u2014 not only instances of this process definition. Ensure the signal name is unique or that engine-wide delivery is intentional.")),
            React.createElement("div", { className: "modify-form__section" },
                React.createElement("div", { className: "modify-form__field" },
                    React.createElement("label", { htmlFor: "signalName" }, "Signal Name"),
 ...
 */
var DefinitionModifyTab = function (props) {
    return (React.createElement(Tabs, null,
        React.createElement(Tab, { label: "Batch Modify" },
            React.createElement(BatchModifyForm, __assign({}, props))),
        React.createElement(Tab, { label: "Message" },
            React.createElement(BatchMessageForm, __assign({}, props))),
        React.createElement(Tab, { label: "Signal" },
            React.createElement(BatchSignalForm, __assign({}, props)))));
};
var definitionTabModify = [
    {
        ...
        render: function (node, _a) {
            ...
            clientExports.createRoot(node).render(React.createElement(React.StrictMode, null,
                React.createElement(DefinitionModifyTab, { api: api, processDefinitionId: processDefinitionId })));
        },
    },
];

export { definitionTabModify as default };
