 ...
 */
var TasklistTabAuditLog = function (_a) {
    ...
    reactExports.useEffect(function () {
        ...
        var fetchData = function () { return __awaiter(void 0, void 0, void 0, function () {
            var processInstanceId, _a, activitiesData, decisionsData, decisionMap, sortedActivities, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, 4, 5]);
                        setIsLoading(true);
                        return [4 /*yield*/, getTask(api, taskId)];
                    case 1:
                    ...
                    case 2:
                        ...
                        decisionMap = mapDecisionsByActivity(decisionsData);
                    ...
                    case 3:
                        err_1 = _b.sent();
                        console.error('Failed to fetch tasklist audit log data:', err_1);
    ...
    if (taskId === undefined) {
        return React.createElement("div", { className: "alert alert-info" }, "No task selected.");
    }
    if (isLoading) {
...
var tasklistAuditLog = [
    {
        ...
        render: function (node, _a) {
            ...
            clientExports.createRoot(node).render(React.createElement(React.StrictMode, null,
                React.createElement(TasklistTabAuditLog, { api: api, taskId: taskId })));
        },
    },
];
