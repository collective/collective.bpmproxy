...
___$insertStylesToHeader("/**\n * Styles for instance-action-unlock plugin.\n * Provides styling for the unlock external tasks dialog.\n */\n.ctn-toolbar .btn-toolbar.unlock-dialog__trigger-btn {\n  margin: 4px 8px;\n}\n\n.unlock-dialog__trigger-btn {\n  padding: 6px 9px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  margin: 5px 8px;\n}\n.unlock-dialog__icon {\n  font-size: 1.33em;\n}\n.unlock-dialog__modal-content {\n  display: flex;\n  flex-direction: column;\n  min-height: 300px;\n}\n.unlock-dialog__close-btn {\n  position: absolute;\n  right: 15px;\n  top: 15px;\n  border: none;\n  background: transparent;\n  font-size: 1.5em;\n  cursor: pointer;\n}\n.unlock-dialog__body {\n  flex: 1;\n  overflow: auto;\n}\n.unlock-dialog__loading, .unlock-dialog__empty {\n  text-align: center;\n  padding: 2em;\n}\n.unlock-dialog__empty {\n  color: #666;\n}\n.unlock-dialog__footer {\n  padding: 1em;\n  display: flex;\n  align-items: center;\n  justify-content: flex-end;\n  gap: 0.5em;\n  border-top: 1px solid #ddd;\n}");
...
function HiLockOpen (props) {
  return GenIcon({"attr":{"viewBox":"0 0 20 20","fill":"currentColor","aria-hidden":"true"},"child":[{"tag":"path","attr":{"d":"M10 2a5 5 0 00-5 5v2a2 2 0 00-2 2v5a2 2 0 002 2h10a2 2 0 002-2v-5a2 2 0 00-2-2H7V7a3 3 0 015.905-.75 1 1 0 001.937-.5A5.002 5.002 0 0010 2z"},"child":[]}]})(props);
}
...
var TaskItem = function (_a) {
    var _b, _c, _d;
    var task = _a.task, isSelected = _a.isSelected, onToggle = _a.onToggle, showBorder = _a.showBorder;
    return (React.createElement("div", { style: {
        ...
        React.createElement("label", { style: {
            ...
            React.createElement("input", { type: "checkbox", checked: isSelected, onChange: onToggle, style: { marginRight: '0.5em', marginTop: '0.2em' } }),
            React.createElement("div", { style: { flex: 1 } },
                React.createElement("div", { style: { fontWeight: 'bold', marginBottom: '0.25em' } }, (_b = task.topicName) !== null && _b !== void 0 ? _b : 'Unknown'),
                React.createElement("div", { style: { fontSize: '0.9em', color: '#666' } },
                    React.createElement("div", null,
                        "Activity: ", (_c = task.activityId) !== null && _c !== void 0 ? _c : 'N/A'),
                    React.createElement("div", null,
                        "Worker: ", (_d = task.workerId) !== null && _d !== void 0 ? _d : 'N/A'),
                    React.createElement("div", null,
                        "Lock expires: ",
                        task.lockExpirationTime ? new Date(task.lockExpirationTime).toLocaleString() : 'N/A'),
                    task.errorMessage && (React.createElement("div", { style: { color: '#d9534f', marginTop: '0.25em' } },
                        "Error: ",
                        task.errorMessage)))))));
};
/**
...
var TaskList = function (_a) {
    var tasks = _a.tasks, selectedTasks = _a.selectedTasks, onToggleTask = _a.onToggleTask, onToggleAll = _a.onToggleAll;
    var isAllSelected = selectedTasks.size === tasks.length && tasks.length > 0;
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { style: { marginBottom: '1em' } },
            React.createElement("label", { style: { display: 'flex', alignItems: 'center', cursor: 'pointer' } },
                React.createElement("input", { type: "checkbox", checked: isAllSelected, onChange: onToggleAll, style: { marginRight: '0.5em' } }),
                React.createElement("strong", null,
                    "Select All (",
                    tasks.length,
                    " tasks)"))),
        React.createElement("div", { style: { border: '1px solid #ddd', borderRadius: '4px' } }, tasks.map(function (task, index) {
            var _a, _b;
            return (React.createElement(TaskItem, { key: (_a = task.id) !== null && _a !== void 0 ? _a : index, task: task, isSelected: selectedTasks.has((_b = task.id) !== null && _b !== void 0 ? _b : ''), onToggle: function () {
                    var _a;
                    onToggleTask((_a = task.id) !== null && _a !== void 0 ? _a : '');
...
var UnlockDialog = function (_a) {
    var api = _a.api, processInstanceId = _a.processInstanceId;
    var _b = reactExports.useState(false), isOpen = _b[0], setIsOpen = _b[1];
    var _c = reactExports.useState([]), lockedTasks = _c[0], setLockedTasks = _c[1];
    var _d = reactExports.useState(new Set()), selectedTasks = _d[0], setSelectedTasks = _d[1];
    var _e = reactExports.useState(false), isLoading = _e[0], setIsLoading = _e[1];
    var _f = reactExports.useState(false), isUnlocking = _f[0], setIsUnlocking = _f[1];
    var _g = reactExports.useState(null), error = _g[0], setError = _g[1];
    var fetchLockedTasks = function () { return __awaiter(void 0, void 0, void 0, function () {
        var tasks, _err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    tasks = (_a.sent());
                    setLockedTasks(tasks !== null && tasks !== void 0 ? tasks : []);
                    return [3 /*break*/, 5];
                case 3:
                    _err_1 = _a.sent();
                    setError('Failed to fetch locked external tasks');
                    console.error('Error fetching locked tasks:', _err_1);
                    return [3 /*break*/, 5];
                case 4:
                    setIsLoading(false);
                    return [7 /*endfinally*/];
    ...
    var handleToggleAll = function () {
        if (selectedTasks.size === lockedTasks.length) {
            ...
            setSelectedTasks(new Set(lockedTasks.map(function (t) { return t.id; }).filter(function (id) { return id !== null && id !== undefined; })));
        }
    };
    var handleUnlock = function () { return __awaiter(void 0, void 0, void 0, function () {
        var unlockPromises, _err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    unlockPromises = Array.from(selectedTasks).map(function (taskId) { return post(api, "/external-task/".concat(taskId, "/unlock")); });
                    return [4 /*yield*/, Promise.all(unlockPromises)];
                case 2:
                    _a.sent();
                    // Refresh the task list
                    return [4 /*yield*/, fetchLockedTasks()];
                case 3:
                    // Refresh the task list
                    _a.sent();
                    setSelectedTasks(new Set());
                ...
                case 4:
                    ...
                    console.error('Error unlocking tasks:', _err_2);
                    return [3 /*break*/, 6];
                case 5:
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("button", { className: "btn btn-default btn-toolbar btn-outline-secondary unlock-dialog__trigger-btn", title: "Unlock External Tasks", onClick: handleOpen },
            React.createElement(HiLockOpen, { className: "unlock-dialog__icon" })),
        React.createElement(ReactModal, { className: "modal-dialog", isOpen: isOpen, onRequestClose: handleClose, shouldCloseOnEsc: true, shouldReturnFocusAfterClose: true, aria: {
            ...
            React.createElement("div", { className: "modal-content unlock-dialog__modal-content" },
                React.createElement("div", { className: "modal-header" },
                    React.createElement("h3", { id: "unlock-tasks-modal-title" }, "Unlock External Tasks")),
                React.createElement("div", { className: "modal-body unlock-dialog__body", id: "unlock-tasks-modal-description" },
                    error && (React.createElement("div", { className: "alert alert-danger", role: "alert" }, error)),
                    isLoading && React.createElement("div", { className: "unlock-dialog__loading" }, "Loading locked tasks..."),
                    !isLoading && lockedTasks.length === 0 && (React.createElement("div", { className: "unlock-dialog__empty" }, "No locked external tasks found for this process instance.")),
                    !isLoading && lockedTasks.length > 0 && (React.createElement(TaskList, { tasks: lockedTasks, selectedTasks: selectedTasks, onToggleTask: handleToggleTask, onToggleAll: handleToggleAll }))),
                React.createElement("div", { className: "modal-footer unlock-dialog__footer" },
                    React.createElement("button", { onClick: handleClose, className: "btn btn-default", disabled: isUnlocking }, "Close"),
                    React.createElement("button", { onClick: function () {
                            void handleUnlock();
                        }, className: "btn btn-primary", disabled: selectedTasks.size === 0 || isUnlocking }, isUnlocking ? 'Unlocking...' : "Unlock ".concat(selectedTasks.size, " task").concat(selectedTasks.size !== 1 ? 's' : '')))))));
};
var instanceActionUnlock = [
    {
        id: 'instanceActionUnlock',
        pluginPoint: 'cockpit.processInstance.runtime.action',
        render: function (node, _a) {
            var api = _a.api, processInstanceId = _a.processInstanceId;
            var root = clientExports.createRoot(node);
            root.render(React.createElement(React.StrictMode, null,
                React.createElement(UnlockDialog, { api: api, processInstanceId: processInstanceId })));
        },
    },
];

export { instanceActionUnlock as default };
