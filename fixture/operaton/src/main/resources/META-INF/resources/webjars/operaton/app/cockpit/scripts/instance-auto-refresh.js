...
var AUTO_REFRESH_POLL_INTERVAL_MS = 1000;
...
function parseActivityData(raw) {
    ...
    try {
        ...
        if (Array.isArray(parsed) && parsed.length >= 2) {
            var activityId = typeof parsed[0] === 'string' ? parsed[0] : null;
            var intervalId = typeof parsed[1] === 'string' ? parsed[1] : null;
...
var ToggleAutoRefreshButton = function (_a) {
    ...
    var _b = reactExports.useState(loadSettings().autoRefresh), isAutoRefreshEnabled = _b[0], setIsAutoRefreshEnabled = _b[1];
    reactExports.useEffect(function () {
        if (!isAutoRefreshEnabled) {
            var previousActivityData = parseActivityData(localStorage.getItem(LAST_ACTIVITY_KEY + processInstanceId));
        ...
        saveSettings(__assign(__assign({}, loadSettings()), { autoRefresh: isAutoRefreshEnabled }));
    }, [isAutoRefreshEnabled, processInstanceId]);
    reactExports.useEffect(function () {
        var intervalId;
        var poll = function () { return __awaiter(void 0, void 0, void 0, function () {
            var previousActivityData, latestActivityId;
            var _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        previousActivityData = parseActivityData(localStorage.getItem(LAST_ACTIVITY_KEY + processInstanceId));
                        ...
                        return [4 /*yield*/, (function () { return __awaiter(void 0, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        ...
                                        case 1:
                                            activities = _c.sent();
                                            return [2 /*return*/, (_b = (_a = activities[0]) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : null];
                                    }
                                });
                            }); })()];
                    case 1:
                        latestActivityId = _c.sent();
                        ...
                        if (previousActivityData[0] !== null && latestActivityId !== previousActivityData[0]) {
                            ...
                            localStorage.setItem(LAST_ACTIVITY_KEY + processInstanceId, JSON.stringify([latestActivityId, (_a = intervalId === null || intervalId === void 0 ? void 0 : intervalId.toString()) !== null && _a !== void 0 ? _a : null]));
                            // Update the AngularJS app
                            reloadAngularRoute();
                        }
                        localStorage.setItem(LAST_ACTIVITY_KEY + processInstanceId, JSON.stringify([latestActivityId, (_b = intervalId === null || intervalId === void 0 ? void 0 : intervalId.toString()) !== null && _b !== void 0 ? _b : null]));
                        return [2 /*return*/];
                }
            });
        }); };
    ...
    return (React.createElement("button", { className: "toggle-auto-refresh-button", title: !isAutoRefreshEnabled ? 'Auto refresh view' : 'Auto refresh view off', "aria-label": !isAutoRefreshEnabled ? 'Auto refresh view' : 'Auto refresh view off', onClick: function () {
            setIsAutoRefreshEnabled(!isAutoRefreshEnabled);
        } }, isAutoRefreshEnabled ? (React.createElement(TbRefresh, { style: { opacity: '1.0', fontSize: '133%' } })) : (React.createElement(TbRefreshOff, { style: { opacity: '0.33', fontSize: '133%' } }))));
};
...
var BUTTON_POSITION = { right: '15px', bottom: '165px' };
/**
 ...
 */
var InstanceDiagramAutoRefresh = function (_a) {
...
var instanceAutoRefresh = [
    {
        ...
        render: function (viewer, _a) {
            ...
            clientExports.createRoot(mountPoint).render(React.createElement(React.StrictMode, null,
                React.createElement(InstanceDiagramAutoRefresh, { api: api, processInstanceId: processInstanceId, viewer: viewer })));
        },
    },
];
