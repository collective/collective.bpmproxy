 ...
 * ```
 */
var DashboardSection = function (_a) {
    var title = _a.title, children = _a.children, _b = _a.initialCollapsed, initialCollapsed = _b === void 0 ? false : _b, _c = _a.isLoading, isLoading = _c === void 0 ? false : _c, emptyMessage = _a.emptyMessage, _d = _a.hasData, hasData = _d === void 0 ? true : _d, onRefresh = _a.onRefresh, headerActions = _a.headerActions, _e = _a.useWrapper, useWrapper = _e === void 0 ? true : _e;
    var _f = reactExports.useState(!initialCollapsed), activeSection = _f[0], setActiveSection = _f[1];
    var toggleSection = function () {
        setActiveSection(!activeSection);
    };
    var headerContent = (React.createElement("header", null,
        React.createElement("div", { className: "row", style: {
            ...
            useWrapper ? (React.createElement("h1", { className: "section-title", style: { margin: 0, flex: 1 } }, title)) : (React.createElement("div", { style: { margin: 0, flex: title ? 1 : 0, fontSize: '14px', fontWeight: 600 } }, title)),
    ...
    var contentSection = (React.createElement(React.Fragment, null, activeSection && (React.createElement("div", null,
        React.createElement("div", { className: "cam-widget-loader loader-wrapper" },
            ...
            !isLoading && !hasData && emptyMessage && (React.createElement("div", { className: "loader-state empty" },
                React.createElement("p", null, emptyMessage))),
            !isLoading && hasData && (React.createElement("div", { className: "loader-state loaded" },
                React.createElement("div", { className: "cam-widget-loader deployed-processes" },
                    React.createElement("div", { className: "loader-state loaded" }, children)))))))));
    if (useWrapper) {
        return (React.createElement("section", { className: "processes-dashboard ".concat(!activeSection ? 'section-collapsed' : '') },
...
var FAVOURITES_ONLY_KEY = 'minimal-history-plugin-integrations-favourites-only';
/**
 * Load favourite process definition keys from localStorage
 */
function loadFavouriteKeys() {
    var storage = getStorage();
    var raw = storage.get(FAVOURITES_KEY);
    if (!raw) {
        return new Set();
    }
    try {
        var favourites = JSON.parse(raw);
        return new Set(favourites.map(function (f) { return f.key; }));
    }
    catch (_a) {
        return new Set();
    }
 ...
 */
function loadFavouritesOnlySetting() {
    var storage = getStorage();
    var value = storage.get(FAVOURITES_ONLY_KEY);
 ...
 */
function saveFavouritesOnlySetting(enabled) {
    var storage = getStorage();
...
var IntegrationsTable = function (_a) {
    var api = _a.api;
    var _b = reactExports.useState([]), tasks = _b[0], setTasks = _b[1];
    var _c = reactExports.useState(new Map()), incidents = _c[0], setIncidents = _c[1];
    var _d = reactExports.useState(new Map()), processNames = _d[0], setProcessNames = _d[1];
    var _e = reactExports.useState(new Map()), processDefKeys = _e[0], setProcessDefKeys = _e[1];
    var _f = reactExports.useState(new Set()), selectedTasks = _f[0], setSelectedTasks = _f[1];
    ...
    reactExports.useEffect(function () {
        ...
        if ((titleElement === null || titleElement === void 0 ? void 0 : titleElement.textContent) === 'Custom Plugins') {
    ...
    var debouncedFetchTasks = reactExports.useCallback(function () {
     ...
     */
    var formatLockTime = function (lockTime) {
        if (!lockTime) {
            return '-';
        }
        ...
        var now = new Date();
        if (lockDate <= now) {
            return "Expired at ".concat(formatDateTime(lockTime));
        }
    ...
    var filteredTasks = tasksWithIssues.filter(function (task) {
        ...
        if (favouritesOnly) {
            ...
            var defKey = (_a = task.processDefinitionKey) !== null && _a !== void 0 ? _a : (task.processDefinitionId ? processDefKeys.get(task.processDefinitionId) : null);
    ...
    var prevFavouritesOnlyRef = reactExports.useRef(favouritesOnly);
    reactExports.useEffect(function () {
        var _a;
        ...
        if (favouritesOnly && !prevFavouritesOnlyRef.current && selectedTasks.size > 0) {
            ...
            var currentFavouriteKeys = loadFavouriteKeys();
            // Check selections against tasks using processDefinitionKey directly
            var validSelections = new Set();
            ...
            for (var _i = 0, _b = Array.from(selectedTasks); _i < _b.length; _i++) {
                var taskId = _b[_i];
                _loop_1(taskId);
            }
    ...
    var handleToggleAll = function () {
        if (selectedTasks.size === filteredTasks.length && filteredTasks.length > 0) {
            ...
            setSelectedTasks(new Set(filteredTasks.map(function (t) { return t.id; }).filter(function (id) { return id !== null; })));
        }
    };
    /**
     * Retry a single task by setting retries to 1
     */
    var handleRetry = function (taskId) { return __awaiter(void 0, void 0, void 0, function () {
        var _err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setActionLoading(function (prev) { return new Set(prev).add(taskId); });
                    _a.label = 1;
                case 1:
                ...
                case 4:
                    _err_2 = _a.sent();
                    console.error('Error retrying task:', _err_2);
     ...
     */
    var handleUnlock = function (taskId) { return __awaiter(void 0, void 0, void 0, function () {
        var _err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 4, 5, 6]);
                    return [4 /*yield*/, post(api, "/external-task/".concat(taskId, "/unlock"), {}, '')];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, fetchTasks()];
                case 3:
                ...
                case 4:
                    _err_3 = _a.sent();
                    console.error('Error unlocking task:', _err_3);
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    _loop_2 = function (taskId) {
                        setActionLoading(function (prev) { return new Set(prev).add(taskId); });
                    };
                    for (_i = 0, taskIds_1 = taskIds; _i < taskIds_1.length; _i++) {
                        taskId = taskIds_1[_i];
                        _loop_2(taskId);
                    }
                    _c.label = 1;
     ...
     */
    var getInstanceUrl = function (processInstanceId) {
        return "#/process-instance/".concat(processInstanceId, "/runtime");
    };
    /**
     * Toggle favourites-only filter
     */
    var handleToggleFavouritesOnly = function () {
        var newValue = !favouritesOnly;
    ...
    // Error state overlay
    if (error) {
        return (React.createElement(DashboardSection, { title: "External Tasks", hasData: false, emptyMessage: "", useWrapper: false },
            React.createElement(ErrorMessage, { message: error }),
            React.createElement("button", { className: "btn btn-default", onClick: function () { return void fetchTasks(); } }, "Retry")));
    }
    var emptyMessage = 'No external tasks with incidents or locked for more than 5 minutes.';
    ...
    return (React.createElement(DashboardSection, { title: "", isLoading: isLoading, hasData: filteredTasks.length > 0, emptyMessage: emptyMessage, onRefresh: function () { return void fetchTasks(); }, useWrapper: false, headerActions: React.createElement(React.Fragment, null,
            selectedTasks.size > 0 && (React.createElement("button", { className: "btn btn-primary btn-sm", onClick: function () { return void handleBatchRetry(); }, disabled: actionLoading.size > 0 },
                "Retry Selected (",
                selectedTasks.size,
                ")")),
            ...
            React.createElement("label", { style: {
                ...
                React.createElement("input", { type: "checkbox", checked: favouritesOnly, onChange: handleToggleFavouritesOnly, style: { cursor: 'pointer', margin: 0, verticalAlign: 'middle' } }),
                React.createElement("span", { style: { lineHeight: '1' } }, "Favourites only"))) },
        React.createElement("table", { className: "cam-table" },
            React.createElement("thead", null,
                React.createElement("tr", null,
                    React.createElement("th", { style: { width: '30px' } },
                        React.createElement("input", { type: "checkbox", checked: selectedTasks.size === filteredTasks.length && filteredTasks.length > 0, onChange: handleToggleAll, title: "Select all" })),
                    ...
                    React.createElement("th", null, "Lock Expires"),
                    React.createElement("th", null, "Retries"),
                    React.createElement("th", null, "Incident"),
                    React.createElement("th", null, "Actions"))),
            React.createElement("tbody", null, filteredTasks.map(function (task) {
                var _a, _b, _c, _d, _e, _f, _g, _h, _j;
                var taskId = (_a = task.id) !== null && _a !== void 0 ? _a : '';
                var processName = task.processDefinitionId
                    ? ((_b = processNames.get(task.processDefinitionId)) !== null && _b !== void 0 ? _b : task.processDefinitionKey)
                    : '-';
                var taskIncidents = task.processInstanceId ? ((_c = incidents.get(task.processInstanceId)) !== null && _c !== void 0 ? _c : []) : [];
                var hasIncident = taskIncidents.length > 0;
                var locked = isLocked(task);
                var loading = actionLoading.has(taskId);
                return (React.createElement("tr", { key: taskId },
                    React.createElement("td", null,
                        React.createElement("input", { type: "checkbox", checked: selectedTasks.has(taskId), onChange: function () {
                                handleToggleTask(taskId);
                            } })),
                    React.createElement("td", null, task.processInstanceId ? (React.createElement("a", { href: getInstanceUrl(task.processInstanceId) }, processName)) : (processName)),
                    React.createElement("td", null, (_d = task.activityId) !== null && _d !== void 0 ? _d : '-'),
                    React.createElement("td", null, (_e = task.topicName) !== null && _e !== void 0 ? _e : '-'),
                    React.createElement("td", { style: { maxWidth: '150px', overflow: 'hidden', textOverflow: 'ellipsis' } }, (_f = task.workerId) !== null && _f !== void 0 ? _f : '-'),
                    React.createElement("td", null, formatLockTime(task.lockExpirationTime)),
                    React.createElement("td", null, (_g = task.retries) !== null && _g !== void 0 ? _g : 0),
                    React.createElement("td", null, hasIncident ? (React.createElement("span", { style: { color: 'red', cursor: 'pointer' }, title: (_j = (_h = taskIncidents[0]) === null || _h === void 0 ? void 0 : _h.incidentMessage) !== null && _j !== void 0 ? _j : 'Incident' }, "\u26A0\uFE0F Yes")) : ('-')),
                    React.createElement("td", null,
                        React.createElement("div", { style: { display: 'flex', gap: '5px' } }, (function () {
                            ...
                            if (locked) {
                                return (React.createElement("button", { className: "btn btn-xs btn-default", onClick: function () {
                                    ...
                                    }, disabled: loading, title: "Unlock task" }, loading ? '...' : 'Unlock'));
                            }
                            return null;
                        })()))));
            })))));
};
var dashboardIntegrations = [
    {
        ...
        render: function (node, _a) {
            ...
            clientExports.createRoot(node).render(React.createElement(React.StrictMode, null,
                React.createElement(IntegrationsTable, { api: api })));
        },
    },
];

export { dashboardIntegrations as default };
