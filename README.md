...
Re-start the Modeler app and you should see the token simulator controls at the
top left of a BPMN diagram.
...
Head to the [Operaton Cockpit](#operaton-cockpit) to manage the processes.
...
After creating the document, fill it and monitor the process in [Operaton Cockpit](#operaton-cockpit).
